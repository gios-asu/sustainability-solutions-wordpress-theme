...
function sustainability_solutions_wordpress_theme_scripts () {
  ...
  wp_register_style( 'slick', get_stylesheet_directory_uri().'/assets/slick/slick.css', array(), '0.0.1', 'all' );
  ...
  wp_register_script( 'slick', get_stylesheet_directory_uri().'/assets/slick/slick.min.js', array(), '0.0.1', 'all' );
